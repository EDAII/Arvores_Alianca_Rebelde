...
class GameManager:
    def __init__(self, root_tk):
        self.root = root_tk
        self.root.title("Aliança Rebelde - Arquivos da Rebelião")
        ...
        self.title_color_accent = "#FFD700"
    ...
    def update_display(self):
        ...
        if self.game_state == "MENU_PRINCIPAL":
            self._display_text_screen(
                "Aliança Rebelde - Floresta de Dados",
                [""],
                "Iniciar Desafio",
                "INTRODUCAO",
            ...
            narrativa = [
                "Bem-vindo(a), Engenheiro(a) de Estruturas.",
                "A Rebelião está armazenando dados críticos roubados do Império.",
                "Esses dados precisam permanecer equilibrados para garantir buscas rápidas e seguras.",
                "Sua missão: aplicar árvores balanceadas para manter a vantagem da Aliança.",
                "Que a Força esteja com você."
            ]
            self._display_text_screen(
                "Iniciando Protocolos de Balanceamento",
                narrativa,
                "Iniciar Missão 1",
                "START_MISSION_1",
            ...
            self._display_text_screen(
                "Operação de Balanceamento Concluída!",
                [ "Excelente trabalho! As estruturas da Rebelião estão estáveis.",
                    "Agora nossos dados podem ser acessados com segurança e velocidade.",
                    "Sua contribuição foi essencial para manter a Rebelião viva."],
                "Ver o Epílogo",
            ...
            narrativa = [
                "As bases de dados rebeldes agora operam em perfeita harmonia.",
                "Seus algoritmos impediram que o Império rastreasse nossos acessos.",
                "Missão cumprida. Que a Força esteja sempre com você."
            ]
            self._display_text_screen(
                "Dados Equilibrados",
                narrativa,
